-- ============================================================
-- 047_fix_pos_checkin_category.sql
-- Fix POS Checkin to issue 0VND tickets of the SAME category as the package
-- Resolves the issue where all package check-ins become DAILY "Khách lẻ"
-- ============================================================
...
BEGIN
    ...
    -- Tạo vé lượt phụ 1, KẾ THỪA TICKET_TYPE_ID CỦA THẺ GỐC ĐỂ PHÂN LOẠI REPORT (Thay vì dùng DAILY ảo)
    INSERT INTO public.tickets (
        ticket_type_id, status, customer_name, customer_phone, valid_from, valid_until, sold_by, price_paid, remaining_sessions, total_sessions, customer_id, card_code, order_id
    ) VALUES (
        v_ticket.ticket_type_id, 'UNUSED'::public.ticket_status, v_ticket.customer_name, v_ticket.customer_phone, v_today, v_today, p_staff_id, 0, 1, 1, v_ticket.customer_id, v_ticket.card_code, v_ticket.order_id
    ...
    IF v_ticket.category = 'LESSON' AND v_ticket.lesson_class_type = 'ONE_ON_TWO' THEN
        INSERT INTO public.tickets (
            ...
            v_ticket.ticket_type_id, 'UNUSED'::public.ticket_status, COALESCE(v_ticket.customer_name_2, 'Học viên 2'), v_ticket.customer_phone, v_today, v_today, p_staff_id, 0, 1, 1, v_ticket.customer_id, v_ticket.card_code, v_ticket.order_id
